...
export const OpenGenerateProjectsSavingsSummary = (session_data: SessionData) => modals.open({
    ...
    size: rem("1000"),
    children: <GenerateProjectsSavingsSummary session_data={session_data} />
})

const GenerateProjectsSavingsSummary = ({session_data}: {session_data: SessionData}) => {
    const eventSourceRefId = useRef<EventSource | null>(null)
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    const [_state, formAction, _pending] = useActionState(generateProjectsSavingsSummary, "")
