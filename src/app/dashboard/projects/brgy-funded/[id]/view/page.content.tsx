...
export default function PageContent({
    session_data,
    projects,
}: Readonly<{session_data: SessionData, projects: ResponseViewProjectsById}>) {
    ...
    useEffect(() => {
        ...
        if (state.message == ResponseDefaultMessage.Success) {
            ...
            redirect("/dashboard/projects/brgy-funded")
        ...
        <Stack>
            <Group align="end">
                ...
                <Flex gap="sm" justify="flex-end" flex={1}>
                    <ActionIcon size="lg">
                        <IconPrinter onClick={() => OpenGenerateProjectsProfileModal(projects_info, session_data)} />
                    </ActionIcon>
                    <Button>Get Started</Button>
                    <Button component={Link} href={"/dashboard/projects/brgy-funded"}>Back</Button>
                </Flex>
            </Group>
            <Paper>
                <Stack gap={0}>
            ...
            <Paper>
                <Flex align="center" justify="space-between">
                    ...
                    <Button onClick={() => OpenUpdateInfraCodeModal(projects_info, session_data)}>Assign Infra Code</Button>
                </Flex>
            </Paper>
            <Paper>
                <Flex mb="md" align="center" justify="space-between">
                    ...
                    <Group>
                        <ActionIcon disabled={projects_remarks.length == 0} size="lg">
                            <IconPrinter onClick={() => OpenGenerateProjectsRemarksModal(projects_info, session_data)} />
                        </ActionIcon>
                        <Button onClick={() => OpenUpdateRemarksModal(projects_info, session_data)}>Add Remarks</Button>
                    </Group>
                </Flex>
                        ...
                        <Flex align="center" justify="space-between">
                            <Stack gap={0}>
                                ...
                                <Group align="center" gap="xs">
                                    ...
                                    <Anchor onClick={() => OpenDeleteRemarksModal(remarks, session_data)} fz="xs" fw="bolder" underline="never">Remove</Anchor>
                                </Group>
                            </Stack>
                            <AvatarGroup>
            ...
            <Paper>
                <Flex align="center" justify="space-between">
                    ...
                    <Button onClick={() => OpenAddProjectsPaymentModal(projects_info, session_data)}>Add Payments</Button>
                </Flex>
                <Divider my="md" />
                <Table>
                    <Table.Thead>
                    ...
                    <Table.Tbody>
                        {project_payments.length > 0 ? project_payments.map((payment, index) => <Table.Tr key={index}>
                            ...
                            <Table.Td>
                                <Anchor onClick={() => OpenDeletePaymentModal(payment, session_data)} underline="never" fw="bold" fz="sm">Remove</Anchor>
                            </Table.Td>
                        </Table.Tr>) : <Table.Tr>
