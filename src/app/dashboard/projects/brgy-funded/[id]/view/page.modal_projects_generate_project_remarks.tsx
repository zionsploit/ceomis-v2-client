...
export const OpenGenerateProjectsRemarksModal = (projects: ResponseProjectsById, session_data: SessionData) => modals.open({
    title: <Text fz="lg" fw="bold" c="dimmed">GENERATE PROJECTS REMARKS</Text>,
    size: rem("1000"),
    children: <GenerateProjectsRemarks session_data={session_data} projects={projects} />
})

const GenerateProjectsRemarks = ({projects, session_data}: { projects: ResponseProjectsById, session_data: SessionData }) => {
