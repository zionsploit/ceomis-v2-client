...
import { Button, Divider, Flex, Group, Select, Stack, TextInput, Text as MText, Checkbox, Grid, rem, ScrollArea, Box, ActionIcon, Alert, NumberInput, Textarea, Radio, Overlay } from "@mantine/core";
...
import { ProjectFundedType, ResponseDefaultMessage } from "@/entity/Response.enum";
...
export const projectsFormSchema = yup.object().shape({
    ...
    appropriation: yup.number().nullable().default(null),
    approved_budget_contact: yup.number().nullable().default(null),
    contractor_id: yup.string().nullable().default(null),
    contract_cost: yup.number().nullable().default(null),
    start_date: yup.string().nullable().default(null),
    target_date: yup.string().nullable().default(null),
    project_type_id: yup.string().nullable().default(null),
    project_category_id: yup.string().nullable().default(null),
    project_sof_id: yup.string().nullable().default(null),
    project_incharge_id: yup.string().nullable().default(null),
    project_takers_id: yup.string().nullable().default(null),
    accomplished: yup.string().nullable().default(null),
                ...
                {() => (
                    <Form>
                        <Stack gap={0}>
                            ...
                            <Divider label="Project Funded Type" labelPosition="left" />
                            <Radio.Group 
                                name="projectFundedType"
                                value={projectFundedType}
                                onChange={setProjectFundedType}
                            >
                                <Group my="md">
                                    <Radio label="Barangay Funded" variant="outline" value={ProjectFundedType.BarangayFunded.toString()} />
                                    <Radio label="City Funded" variant="outline" value={ProjectFundedType.CityFunded.toString()} />
                                </Group>
                            </Radio.Group>
                            ...
                            <Box hidden={projectFundedType == ProjectFundedType.BarangayFunded.toString()}>
                                <Stack>
                                    <Divider />
                                    <Group align="start">
                                        <Box flex={1}>
