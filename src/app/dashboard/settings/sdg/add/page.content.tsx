...
import { actionAddSdg } from "./page.action"
...
export const sdgSchema = yup.object().shape({
    name: yup.string().required("Sdg name is required!")
})
...
export default function Content({
    ...
    const [state, formAction, pending] = useActionState(actionAddSdg, {message: ResponseDefaultMessage.None, response_data: ""})
    const toastIdRef = useRef<string | null>(null)

    useEffect(() => {
        pagesTitleContext.mutateState({
            ...PageTitleContextDefault,
            title: "Add Sustainable Development Goals"
        })
